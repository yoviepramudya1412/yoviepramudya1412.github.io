...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:se="http://www.opengis.net/se" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <se:Name>LokasiBandara_PT</se:Name>
    <UserStyle>
      <se:Name>LokasiBandara_PT</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Bukan</se:Name>
          <se:Description>
            <se:Title>Bukan</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>REMARK</ogc:PropertyName>
              <ogc:Literal>Bukan</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PointSymbolizer>
        ...
        <se:Rule>
          <se:Name>Khusus</se:Name>
          <se:Description>
            <se:Title>Khusus</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>REMARK</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Sekunder</se:Name>
          <se:Description>
            <se:Title>Sekunder</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>REMARK</ogc:PropertyName>
              <ogc:Literal>Sekunder</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PointSymbolizer>
            <!--QgsMarkerSymbolLayer RasterMarker not implemented yet-->
        ...
        <se:Rule>
          <se:Name>Tersier</se:Name>
          <se:Description>
            <se:Title>Tersier</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>REMARK</ogc:PropertyName>
              <ogc:Literal>Tersier</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PointSymbolizer>
            <!--QgsMarkerSymbolLayer RasterMarker not implemented yet-->
